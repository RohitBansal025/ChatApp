...
const WelcomePage = () => {
  const SocialArray = [
    {
      bg: "#2b3137",
      link: "https://github.com/RohitBansal025",
    ...
    {
      bg: "#0A66C2",
      link: "https://www.linkedin.com/in/rohit-bansal-cyberguy/",
    ...
    <Box widht={"100%"} sx={{ py: 4 }}>
      ...
      >
        <Box>
          ...
          >
            A robust web-based Real-Time Chat App developed by Rohit Bansal.
          </Typography>
      ...
      <Box mt={10}>
        <Stack spacing={2}>
          ...
          <Typography variant="body1">
            ...
            Rohit Bansal. Boasting not only a visually appealing UI but also
